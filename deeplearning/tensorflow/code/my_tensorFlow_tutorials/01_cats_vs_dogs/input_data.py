...
def get_files(file_dir):
    ...
    # 为 shuffle 做准备. 因为 shuffle 是按行打乱的.    
    # np.array() 会将[]中的个数作为行数, 各个list的长度为列数.因此各个list应该等长. 
...
def get_batch(image, label, image_W, image_H, batch_size, capacity):
    ...
    # 如果想看到正常的图片，请注释掉tf.image.per_image_standardization(image) 和 
