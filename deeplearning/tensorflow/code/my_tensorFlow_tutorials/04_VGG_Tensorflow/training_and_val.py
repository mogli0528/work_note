...
def make_if_not_exists(file_path):
...
def train():
    ...
    pre_trained_weights = '/home/klm/ws_data/tensorflow/vgg/vgg16_pretrain/vgg16.npy'
    data_dir = '/home/klm/ws_data/tensorflow/cifar-10-batches-py/'
    train_log_dir = '/home/klm/ws_data/tensorflow/vgg/logs/train/'
    val_log_dir = '/home/klm/ws_data/tensorflow/vgg/logs/val/'
    
    check_if_exist(pre_trained_weights)
    check_if_exist(data_dir)

    make_if_not_exists(train_log_dir)
    make_if_not_exists(val_log_dir)
    ...
    try:
        for step in np.arange(MAX_STEP):
            ...
            print tf.shape(tra_images), tf.shape(tra_image_batch)
...
def evaluate():
    with tf.Graph().as_default():
        ...
        log_dir = '/home/klm/ws_data/tensorflow/vgg/logs/train/'
        test_dir = '/home/klm/ws_data/tensorflow/cifar-10-batches-py/'
        n_test = 10000
