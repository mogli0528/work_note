...
def convert_to_tfrecord(images, labels, save_dir, name):
    ...
    for i in np.arange(0, n_samples):
        try:
            ...
            # 如果文件大小为 0, IOERROR 为 cannot identify image file.
            print('error: %s' %e)   
            print('Skip it!\n')
    writer.close()
...
test_dir = '/home/klm/ws_data/tensorflow/notMNIST/notMNIST_small/'
save_dir = '/home/klm/ws_data/tensorflow/notMNIST/tfrecords/'
BATCH_SIZE = 25

#Convert test data: you just need to run it ONCE !
name_test = 'notMNIST_small_test.tfrecords'
images, labels = get_file(test_dir)
make_if_not_exists(save_dir)

tfrecords_file = save_dir + name_test
if not check_if_exist(tfrecords_file):
